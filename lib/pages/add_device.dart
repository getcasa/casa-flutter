...
class AddDevicePage extends StatefulWidget {
  ...
  const AddDevicePage({Key key, this.homeId, this.rooms, this.device})
      : super(key: key);
}
                  ...
                  child: FlatButton(
                    ...
                    onPressed: () {
                      dialogs.select(
                          context,
                          'Rooms',
                          widget.rooms.map((room) => room['name']).toList(),
                          selectedRoom, (index) {
                        setState(() {
                          selectedRoom = index;
                        });
                ...
                child: Container(
                  ...
                  child: Material(
                    child: FlatButton(
                      ...
                      onPressed: () async {
                        try {
                          await request.addDevice(
                              widget.homeId, widget.rooms[selectedRoom]['id'], {
                        ...
                        Navigator.pushReplacement(
                          ...
                          MaterialPageRoute(
                              builder: (context) =>
                                  RoomsPage(homeId: widget.homeId)),
                        );
                      },
                      child: Text('Add',
                          style: TextStyle(
